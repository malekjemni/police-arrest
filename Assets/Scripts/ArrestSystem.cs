...
public class ArrestSystem : MonoBehaviour
{
    ...
    public void CheckForOutlaw()
    {
        if (!isActivated)
        {
            ...
            foreach (Collider collider in colliders)
            {
                ...
                {
                    outlawOutline = collider.GetComponent<Outline>();
                    if (outlawOutline != null)
                    {
                        outlawOutline.enabled = true;
                    }
    ...
    private void UpdateOutlawMaterial()
    {
        ...
        foreach (GameObject outlawToRemove in outlawsToRemove)
        {
            ...
            Outline outlineToRemove = outlawToRemove.GetComponent<Outline>();
            if (outlineToRemove != null)
            {
                outlineToRemove.enabled = false;
            }
        }
    }
